...
I am a Computer Science Ph.D. candidate at [University of Illinois Urbana-Champaign](https://illinois.edu/) advised by Prof. [Jimeng Sun](https://www.sunlab.org/). I am also working closely with Prof. [Jiawei Han](https://hanj.cs.illinois.edu), Prof. [Sheng Wang](https://homes.cs.washington.edu/~swang/), Dr. [Lijun Wu](https://apeterswu.github.io/), Dr. [Kun Qian](https://www.linkedin.com/in/kun-qian-7537611aa/) and [Tian Wang](https://www.linkedin.com/in/tianwng/). Before that, I earned my B.Eng and MS degree in Automation at [Tsinghua University](https://www.tsinghua.edu.cn/).
...
07/2025 Our [DeepRetrieval: Hacking Real Search Engines and Retrievers with Large Language Models via Reinforcement Learning](https://openreview.net/pdf?id=u9JXu4L17I) is accepted by *COLM 2025*. <br>

07/2025 Our [GT2Vec: Large Language Models for Knowledge Graph Augmented Text Embedding](https://arxiv.org/pdf/2410.11235?) is accepted by *KDD 2025 Workshop SKnow-LLM*. <br>

05/2025 Starting **Applied Scientist Internship** at Amazon SFAI, Palo Alto, advised by [Hyokun Yun](https://bikestra.github.io/) and [Lihong Li](https://lihongli.github.io/).<br>

04/2025 Our [Pisces: A multi-modal data augmentation approach for drug combination synergy prediction](https://www.cell.com/cell-genomics/fulltext/S2666-979X(25)00148-X) is accepted by *Cell Genomics*. <br>
...
05/2024 Starting **Applied Scientist Internship** at Amazon, Palo Alto, advised by [Sheng Wang](https://homes.cs.washington.edu/~swang/) and [Danai Koutra](https://web.eecs.umich.edu/~dkoutra/).<br>
